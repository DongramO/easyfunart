...
=======
        insert = [body.reviewWatchDate, Number(body.reviewGrade), body.reviewContent, 'tt',
          moment().format('YYYY-MM-DD'),  body.exId, userId]
      } else {
        insert = [body.reviewWatchDate,Number(body.reviewGrade), body.reviewContent, file.location,
>>>>>>> Stashed changes
          moment().format('YYYY-MM-DD'),  body.exId, userId]
      }
